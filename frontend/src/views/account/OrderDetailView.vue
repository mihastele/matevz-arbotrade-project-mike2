...
<template>
  <div>
    <RouterLink to="/account/orders" class="text-primary-600 hover:text-primary-700 flex items-center mb-6">
      ...
      <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div class="lg:col-span-2 space-y-6">
          ...
          <div class="bg-white rounded-lg shadow-sm p-6">
            <h2 class="font-semibold text-secondary-900 mb-4">Shipping Address</h2>
            <div v-if="order.shippingAddress" class="text-secondary-600">
    ...
    <div v-else class="text-center py-16">
      ...
      <RouterLink to="/account/orders" class="text-primary-600 hover:text-primary-700">
        Back to Orders
      </RouterLink>
    </div>
  </div>
